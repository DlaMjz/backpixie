...
<a href="index.php" style="text-decoration: none; color:black; ";  > <h1>Tienda de ropa</h1> </a>  
  ...
  <h2>Lista de ropa</h2>
  <p>La siguiente lista muestra los datos de la ropa cuyo precio es mayor a 500 actualmente en stock.</p>
  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        $consulta="SELECT * FROM `stockdisponible` WHERE `precio` < '500'";
