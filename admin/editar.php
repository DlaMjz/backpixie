...
$consulta = "SELECT * FROM stockdisponible WHERE id=$id";
...
<html lang="en">
    ...
    <body>
        ...
        $tipo_prenda=$datos["tipodeprenda"];
        $marca=$datos["marca"];
        $talle=$datos["talle"];
        $precio=$datos["precio"];
        $imagen=$datos['imagen'];
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="tipodeprenda" placeholder="tipo de prenda" value="<?php echo "$tipo_prenda"; ?>">
            <label>Marca</label>
            ...
            <input type="Text" name="link" placeholder="Link de Pago"> <br><br>
            <input type="submit" name="guardar_cambios" value="Guardar Cambios">
            <button type="submit" name="Cancelar" formaction="listaradmin.php">Cancelar</button>
        </form>
        ...
        if(array_key_exists('guardar_cambios',$_POST))
        {
            ...
            $tipo_prenda= $_POST['tipodeprenda'];
            $marca=$_POST['marca'];
            $talle=$_POST['talle'];
            $precio=$_POST['precio'];
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE stockdisponible SET tipodeprenda='$tipo_prenda', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen', link='$link' WHERE id=$id";
